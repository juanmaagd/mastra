...
type Shared_Auxiliary_604 =
  ...
  | {
      op: 'and' | 'or';
      args: Shared_Auxiliary_604[];
    }
  | {
      op: 'not';
      arg: Shared_Auxiliary_604;
    }
  | {
      spans:
        | {
            some: Shared_Auxiliary_622;
          }
        | {
            none: Shared_Auxiliary_622;
          };
    }
  | {
      scores:
...
type Shared_Auxiliary_622 =
  ...
  | {
      op: 'and' | 'or';
      args: Shared_Auxiliary_622[];
    }
  | {
      op: 'not';
      arg: Shared_Auxiliary_622;
    };

type Shared_Auxiliary_656 =
  | {
      op: 'and' | 'or';
      args: Shared_Auxiliary_656[];
    }
  | {
      op: 'not';
      arg: Shared_Auxiliary_656;
    }
  | {
      traces:
        | {
            some: Shared_Auxiliary_604;
          }
        | {
            none: Shared_Auxiliary_604;
          };
    };
...
export type PostObservabilityTracesQuery_Body = {
  ...
  where?: Shared_Auxiliary_604 | undefined;
  group?:
    | {
        by: ['threadId'];
      }
...
export type PostObservabilityThreadsQuery_Body = {
  ...
  where?: Shared_Auxiliary_656 | undefined;
  page: {
    limit: number;
    after?: (string | null) | undefined;
  };
